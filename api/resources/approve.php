...
class ApproveResource extends Database {
    private $userID;
    private $resourceID;
    ...
    /**
     * Handles the execution of the API endpoint for approving resources.
     *
     ...
     * Retrieves the resource ID from the request and approves the resource using the approveResource() method.
    ...
    /**
     * Approves a resource in the database by updating its status to 'approved'.
     * 
     * This method executes an SQL query to update the status of a resource with 
     * the specified ID to 'approved' in the database. It takes no parameters directly 
     ...
     * @return void
     */
    private function approveResource() {
        // SQL query to approve a resource in the database
...
$approveResource = new ApproveResource();
